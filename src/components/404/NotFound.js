    ...
    <div className={styles["wrapper"]}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
        ...
        <g id={styles["Layer_12"] + " " + styles["yellow-back-fig"]} data-name="Layer 12">
          ...
          <g id={styles["round-conf"]}>
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c1"]}
            ...
            />
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c2"]}
            ...
            />
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c3"]}
            ...
            />
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c4"]}
            ...
            />
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c5"]}
            ...
            />
            <path
              className={styles["cls-1"] + " " + styles["circle"] + " " + styles["c6"]}
        ...
        <g id={styles["fortyfour"]} data-name="Layer 2">
          <g className={styles["four"] + " " + styles["a"]}>
            <rect
          ...
          <g className={styles["four"] + " " + styles["b"]}>
            <rect
              className={styles["cls-2"]}
              x="1558.84"
              y="391.91"
        ...
        <g id={styles["umbrella"]} data-name="Layer 3">
          <g>
            <circle
        ...
        <g id={styles["pillow"]} data-name="Layer 4">
          <path
            className={styles["cls-1"]}
        ...
        <g id={styles["cup"]} data-name="Layer 7">
          <polygon
            className={styles["cls-1"]}
        ...
        <g id={styles["clock"]} data-name="Layer 8">
          <circle
            className={styles["cls-5"]}
            cx="847.7"
            cy="247.59"
          ...
          />
          <rect
            className={styles["cls-3"] + " " +  styles["clock-hand-1"]}
            x="845"
            y="189.5"
            width="6.04"
            height="58"
          ...
          />
          <rect
            className={styles["cls-3"] + " " + styles["clock-hand-2"]}
            x="845"
            y="209.5"
            width="6.04"
            height="38"
        ...
        <g id={styles["box"]} data-name="Layer 9">
          <g id={styles["box-top"]}>
            <polygon
              className={styles["cls-8"]}
        ...
        <g id={styles["rucksack"]} data-name="Layer 6">
          <g id={styles["stripe"]}>
            <path
        ...
        <g id={styles["bike"]} data-name="Layer 5">
          <path
            className={styles["cls-8"] + " " + styles["wheel"]}
